...
export const Delete: FC<DeleteModalProps> = (props): JSX.Element => {
  console.log(props.itemToDeletedId)
  const [mutate, {data, loading}] = useMutation(deleteInvite());
  ...
  return (
    <>
      <div className="fixed inset-0 flex items-center justify-center"style={!props.isOpen ?{zIndex:'-10'} : undefined}>
      </div>
            ...
            >
              ...
              <div className="mt-2">
                  <p className="text-sm text-gray-500">
                    Are you sure you wish to delete this person from the Invite List?
                  </p>
                </div>
              <div className="px-4 py-3 mt-3 text-right sm:px-6">
                ...
                <button
                  ...
                  onClick={() => {deleteInviteFunction(); data && props.closeModal()}}
                >
                  Confirm
                </button>
