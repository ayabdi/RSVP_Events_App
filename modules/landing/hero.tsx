        ...
        >
          <div className="text-center">
            <h2 className="mt-6 text-3xl font-bold text-white md:text-5xl">
              Manage any event <br /> with ease
            </h2>{" "}
            <br />
            <p className="text-xl font-medium tracking-wider text-gray-300">
              {" "}
              Create invitations for both in-person and virtual events
            </p>
          ...
          <div className="items-center md:flex md:space-x-6">
            <div className="md:w-1/2">
              <h3 className="text-4xl font-semibold text-gray-800">
                An end-to-end <br /> in-person and virtual <br /> event
                management platform that wows <br />{" "}
              </h3>
            </div>
      ...
      <section className="bg-white">
        <div className="max-w-5xl px-6 py-16 mx-auto">
          <div className="items-center md:flex md:space-x-6">
            ...
            <div className="mt-8 md:mt-0 md:w-1/2">
              <h3 className="text-4xl font-semibold text-gray-800">
                A beautiful, bespoke event <br /> experience with <br />{" "}
                powerful features
                <br />{" "}
              </h3>
            </div>
